...
echo "  python scripts/vlm/eval_vqa.py \\"
...
echo "    --start-idx 0 --end-idx 500 \\"
echo "    --output outputs/vqa_results.csv \\"
echo "    --batch-size 1"
echo ""
...
echo "    --image-root ${COCO_IMG} \\"
echo "    --subset-file ${DATA_ROOT}/vqa/all_correct.ids \\"
echo "    --eps 4/255 --alpha 1/255 --steps 100 \\"
echo "    --start-idx 0 --end-idx 500 \\"
echo "    --output-dir outputs/attacks/vlm_fare \\"
echo "    --batch-size 1"
